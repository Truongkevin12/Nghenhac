    ...
    <div class="col-md-10" id="ds">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <a class="btn btn-success" href="{{route('themloaitin')}}" role="button">Thêm</a>
            <a class="btn btn-primary" href="/loaitin/capnhatloaitin/{{$item->id}}" role="button">Sửa</a>
            <a class="btn btn-danger" href="/loaitin/xoa/{{$item->id}}" role="button">Xoá</a>
